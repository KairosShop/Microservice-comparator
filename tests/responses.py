...
def res_full_prod():
    ...
    return dict({
        "body": {
            "all_in_one": "{'Mercado Soriana': [10, 636], 'Sams Club': [10, 638], 'Walmart': [10, 651], 'Aurrera': [10, 659], 'Soriana': [10, 699]}",
...
def res_half_prod():
    ...
    return dict({
        "body": {
            "all_in_one": "{'Walmart': [5, 187.0], 'Mercado Soriana': [5, 235.0], 'Sams Club': [5, 259.0], 'Aurrera': [5, 318.0], 'Soriana': [5, 360.0]}",
...
def res_one_market_all_prod():
    ...
    return dict({
        "body": {
            "all_in_one": "{'Walmart': [10, 651.0], 'Sams Club': [7, 571.0], 'Aurrera': [6, 501.0], 'Soriana': [6, 461.0], 'Mercado Soriana': [5, 409.0]}",
...
def res_two_markets_all_prod():
    ...
    return dict({
        "body": {
            "all_in_one": "{'Walmart': [10, 651.0], 'Mercado Soriana': [10, 651.0], 'Sams Club': [7, 571.0], 'Aurrera': [6, 501.0], 'Soriana': [6, 461.0]}",
...
def res_some_prod():
    ...
    return dict({
        "body": {
            "all_in_one": "{'Aurrera': [6, 271.0], 'Soriana': [6, 434.0], 'Mercado Soriana': [6, 412.0], 'Walmart': [5, 371.0], 'Sams Club': [4, 246.0]}",
...
def res_one_dif_prod():
    ...
    return dict({
        "body": {
            "all_in_one": "{'Walmart': [1, 10.0], 'Soriana': [1, 22.0], 'Sams Club': [1, 42.0], 'Aurrera': [1, 72.0], 'Mercado Soriana': [1, 84.0]}",
