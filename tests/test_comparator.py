...
from context import markets_images, products_images, markets_ids, products_ids
...
class MainTest(TestCase):
    def setUp(self):
        ...
        self. markets_images = markets_images()
        self.products_images = products_images()
        self.markets_ids = markets_ids()
    ...
    def test_full_products(self):
        ...
        fake_data = {'cart': [self.user_info, self.markets_id, self.markets_loc, self.products, self.quantity, full_prod(), self.markets_images, self.products_images, self.markets_ids, self.products_ids]}
    ...
    def test_half_products(self):
        ...
        fake_data = {'cart': [self.user_info, self.markets_id, self.markets_loc, self.products, self.quantity, half_prod(), self.markets_images, self.products_images, self.markets_ids, self.products_ids]}
        response = self.client.post(url_for('comparator'), json=fake_data)
        self.assertEquals(response.json, res_half_prod())

    def test_one_market_all_products(self):
        """Test one supermarket with all products."""
        fake_data = {'cart': [self.user_info, self.markets_id, self.markets_loc, self.products, self.quantity, one_market_all_prod(), self.markets_images, self.products_images, self.markets_ids, self.products_ids]}
        response = self.client.post(url_for('comparator'), json=fake_data)
    ...
    def test_two_markets_all_products(self):
        ...
        fake_data = {'cart': [self.user_info, self.markets_id, self.markets_loc, self.products, self.quantity, two_markets_all_prod(), self.markets_images, self.products_images, self.markets_ids, self.products_ids]}
        response = self.client.post(url_for('comparator'), json=fake_data)
    ...
    def test_some_products(self):
        ...
        fake_data = {'cart': [self.user_info, self.markets_id, self.markets_loc, self.products, self.quantity, some_prod(), self.markets_images, self.products_images, self.markets_ids, self.products_ids]}
        response = self.client.post(url_for('comparator'), json=fake_data)
        self.assertEquals(response.json, res_some_prod())

    def test_no_products(self):
        """Test all supermarkets with no propducts."""
        fake_data = {'cart': [self.user_info, self.markets_id, self.markets_loc, self.products, self.quantity, no_prod(), self.markets_images, self.products_images, self.markets_ids, self.products_ids]}
        response = self.client.post(url_for('comparator'), json=fake_data)
    ...
    def test_one_same_product(self):
        ...
        fake_data = {'cart': [self.user_info, self.markets_id, self.markets_loc, self.products, self.quantity, one_same_prod(), self.markets_images, self.products_images, self.markets_ids, self.products_ids]}
        response = self.client.post(url_for('comparator'), json=fake_data)
    ...
    def test_one_dif_product(self):
        ...
        fake_data = {'cart': [self.user_info, self.markets_id, self.markets_loc, self.products, self.quantity, one_dif_prod(), self.markets_images, self.products_images, self.markets_ids, self.products_ids]}
        response = self.client.post(url_for('comparator'), json=fake_data)
